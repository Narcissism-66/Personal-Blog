...
<!--        标签-->
      ...
      <div class="flex items-center gap-4 ">
        ...
        <img
            ...
            alt="User Avatar"
            class="h-8 w-8 object-cover rounded-full hover:scale-110 active:scale-90 hc-transition"
            @click="Qualification()"
        />
        <ThemeSwitch/>
      </div>
