...
<template>
  <contextHolder/>
  <div class=" flex flex-wrap max-h-screen  max-w-screen  overflow-y-scroll">
    <!-- 主内容区域 -->
    <div class="w-3/5 blog-w-full items-center justify-center mx-auto font-kai gap-4 h-fit rounded-xl p-4 mt-24 bg-white">
      <!-- 主内容可以放在这里 -->
