...
<template>
  <nav class="basic-color fixed top-0 left-0 w-full shadow-md z-50 shadow-gray-200 dark:shadow-blue-400 bg">
    <div class="container mx-auto flex justify-between items-center py-4 px-6 ">
      ...
      <div class="flex items-center gap-4 ">
        <!--  加上了 :  -->
        <img
            :src="options.data.avator"
            alt="User Avatar"
            class="h-8 rounded-full hover:scale-110 active:scale-90"
