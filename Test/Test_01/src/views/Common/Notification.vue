...
<template>
  <contextHolder/>
  <div class="h-screen w-5/6 mx-auto grid grid-cols-[2fr,7fr] gap-4">
    <!-- 侧边栏 -->
...
<!--    通过修改 options.selected.notificationType 来获取不同的 options.currentNotification 是实现点击按钮后显示对应内容的核心机制-->
    <div class="p-5">
      <div class="flex flex-nowrap mx-auto items-center justify-center">
        ...
        <div class="h-fit w-fit hover:scale-110 active:scale-90" @click="clearNotification(0)">
    ...
    <!-- 主内容区域 -->
    <div class="flex flex-wrap p-4 h-fit">
